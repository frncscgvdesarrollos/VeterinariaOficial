...
export default function DatosMascotas({children}) {
  return (
    <div>
    <div className=' width-full bg-gray-800'>
        ...
        <div className=' width-full flex justify-space-around p-10  text-white'>
            ...
            <h2 className='text-3xl borde-pasos p-8 bg-gray-500'>2</h2>
            <h3 className='text-3xl borde-pasos p-8 bg-gray-800'>3</h3>
        </div>
